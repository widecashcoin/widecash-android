package com.widecash.wallet;

import android.text.format.DateUtils;

import com.widecash.core.coins.AsiacoinMain;
import com.widecash.core.coins.AuroracoinMain;
import com.widecash.core.coins.BatacoinMain;
import com.widecash.core.coins.BitcoinMain;
import com.widecash.core.coins.BitcoinTest;
import com.widecash.core.coins.BlackcoinMain;
import com.widecash.core.coins.BurstMain;
import com.widecash.core.coins.CanadaeCoinMain;
import com.widecash.core.coins.CannacoinMain;
import com.widecash.core.coins.ClamsMain;
import com.widecash.core.coins.ClubcoinMain;
import com.widecash.core.coins.CoinID;
import com.widecash.core.coins.CoinType;
import com.widecash.core.coins.DashMain;
import com.widecash.core.coins.DigibyteMain;
import com.widecash.core.coins.DigitalcoinMain;
import com.widecash.core.coins.DogecoinMain;
import com.widecash.core.coins.DogecoinTest;
import com.widecash.core.coins.EguldenMain;
import com.widecash.core.coins.FeathercoinMain;
import com.widecash.core.coins.GcrMain;
import com.widecash.core.coins.GuldenMain;
import com.widecash.core.coins.JumbucksMain;
import com.widecash.core.coins.WidecashMain;
import com.widecash.core.coins.LitecoinMain;
import com.widecash.core.coins.LitecoinTest;
import com.widecash.core.coins.MonacoinMain;
import com.widecash.core.coins.NamecoinMain;
import com.widecash.core.coins.NeoscoinMain;
import com.widecash.core.coins.NovacoinMain;
import com.widecash.core.coins.NuBitsMain;
import com.widecash.core.coins.NuSharesMain;
import com.widecash.core.coins.NxtMain;
import com.widecash.core.coins.OKCashMain;
import com.widecash.core.coins.ParkbyteMain;
import com.widecash.core.coins.PeercoinMain;
import com.widecash.core.coins.PotcoinMain;
import com.widecash.core.coins.ReddcoinMain;
import com.widecash.core.coins.RubycoinMain;
import com.widecash.core.coins.ShadowCashMain;
import com.widecash.core.coins.UroMain;
import com.widecash.core.coins.VergeMain;
import com.widecash.core.coins.VertcoinMain;
import com.widecash.core.coins.VpncoinMain;
import com.widecash.core.coins.RichcoinMain;
import com.widecash.core.coins.IxcoinMain;
import com.widecash.core.network.CoinAddress;
import com.widecash.stratumj.ServerAddress;
...
public class Constants {
    ...
    public static final String BINARY_URL = "https://github.com/widecashcoin/widecash-android/releases";

    public static final String VERSION_URL = "https://widecashproject.com/version";
    public static final String SUPPORT_EMAIL = "support@widecashproject.com";
    ...
    public static final List<CoinAddress> DEFAULT_COINS_SERVERS = ImmutableList.of(
            ...
            new CoinAddress(WidecashMain.get(),     new ServerAddress("node1.widecash.org", 5001),
                                                    new ServerAddress("node2.widecash.org", 5001)),
...
//        COINS_ICONS.put(CoinID.URO_MAIN.getCoinType(), R.drawable.uro);
        ...
        COINS_ICONS.put(CoinID.widecash_MAIN.getCoinType(), R.drawable.widecash);
...
//        COINS_BLOCK_EXPLORERS.put(CoinID.URO_MAIN.getCoinType(), "https://chainz.cryptoid.info/uro/tx.dws?%s");
        ...
        COINS_BLOCK_EXPLORERS.put(CoinID.widecash_MAIN.getCoinType(), "https://wchcore.com/tx/%s");
    }
